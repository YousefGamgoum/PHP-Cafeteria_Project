    ...
    <div class="container py-5">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4>Order Details #<?= htmlspecialchars($orderDetails['order_id']) ?></h4>
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Order Time:</strong> <?= htmlspecialchars($orderDetails['date']) ?></p>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <select name="status" class="form-select w-auto">
                            <option value="pending" <?= $orderDetails['status'] === 'pending' ? 'selected' : '' ?>>
                                Pending</option>
                            <option value="confirmed" <?= $orderDetails['status'] === 'confirmed' ? 'selected' : '' ?>>
                                Confirmed</option>
                            <option value="shipped" <?= $orderDetails['status'] === 'shipped' ? 'selected' : '' ?>>
                                Shipped</option>
                        </select>
        ...
        <div class="order-card mb-3 p-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-end">
                    <a href="?order_id=<?= htmlspecialchars($order['order_id']) ?>" class="btn btn-outline-primary">View
                        Details</a>
                </div>
            </div>
        </div>
