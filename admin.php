...
<div style="margin-left:25%; font-size:25px;" class="dropdown-container mt-5">
        <label for="userDropdown">Choose user:</label>
        <br>
        <select id="userDropdown" name="user_id">
...
<div class= "menu" style="margin-top:60px;">
    <div class="container">
        ...
        <div data-aos="fade-up">
            <h2 class="text-center w-60" style="width:300px; margin-left:400px;">OUR CAFE MENU </h2>
        </div>
        </div>
...
try {
    ...
    foreach ($result as $category) {
        ...
        echo "<div data-aos='zoom-in'>";
            echo "<div id='IMGmenu' class='card' style='width: 18rem;'>";
              echo "<img  src='./assets/images/{$category['image']}' class='card-img-top' alt=''>";
            ...
            echo "<option selected disabled>Select Room</option>";
                try{
                    ...
                    foreach($result as $Cat){
                            ...
                            echo "<option value={$Cat['id']} >{$Cat['room_number']}</option>";
